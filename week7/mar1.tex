...
of this program will be the final output of the final gate, which is one boolean function. In the other direction, the confirmed S-line
program can have each variable assignment become a gate in the circuit. These gates will be combined in the order of the variable
assignments. 

...
Note that this matrix is the same as 
the standard rotation matrix. This is because of
cosine and sine identities. Cosine 
is positive in the first quadrant 
but sine is positive in first quadrant 
and negative in second quadrant.
